...
class CatInfo extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="main-body cats-body" style={{backgroundImage: `url(/images/cafe-bg7.jpg)`,backgroundSize: "cover",backgroundPosition:"center",backgroundRepeat:'no-repeat'}}>
          <h3>Meet the Cats</h3>
          <div className="wrap-cats">
            ...
            <div className="cats-cards">
              <img src="/images/catimages/cat2.jpg" alt="cats" />
              <Accordion>
                <Card>
                  <Card.Header>
            ...
            <div className="cats-cards">
              <img src="/images/catimages/cat3.jpg" alt="cats" />
              <Accordion>
                <Card>
                  <Card.Header>
            ...
            <div className="cats-cards">
              <img src="/images/catimages/cat4.jpg" alt="cats" />
              <Accordion>
                <Card>
                  <Card.Header>
            ...
            <div className="cats-cards">
              <img src="/images/catimages/cat6.jpg" alt="cats" />
              <Accordion>
                <Card>
                  <Card.Header>
            ...
            <div className="cats-cards">
              <img src="/images/catimages/cat7.jpg" alt="cats" />
              <Accordion>
                <Card>
                  <Card.Header>
            ...
            <div className="cats-cards">
              <img src="/images/catimages/cat8.png" alt="cats" />
              <Accordion>
                <Card>
                  <Card.Header>
